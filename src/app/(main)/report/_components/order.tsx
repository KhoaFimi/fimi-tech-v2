	...
	return (
		<div className='flex w-full flex-col items-center justify-start gap-y-1.5 rounded-md bg-primary px-2 py-2 shadow-md'>
			...
			<div className='flex w-full flex-col items-start gap-y-1 lg:flex-row lg:justify-evenly'>
				<div className='flex items-start gap-x-1 text-sm font-semibold text-white/90 lg:text-base'>
					<Calculator
						strokeWidth={3}
		...
		<div>
			<div className='hidden grid-cols-3 gap-2 lg:grid'>
				<div className='flex flex-col items-center justify-center gap-1.5 rounded-md bg-primary p-1.5 text-white'>
					<p className='text-base font-semibold'>Đơn đã phê duyệt</p>
					<p className='text-base font-semibold'>{data.approve}</p>
				</div>
				<div className='flex flex-col items-center justify-center gap-1.5 rounded-md bg-primary p-1.5 text-white'>
					<p className='text-base font-semibold'>Đơn chưa hoàn tất </p>
					<p className='text-base font-semibold'>{data.pending}</p>
				</div>
				<div className='flex flex-col items-center justify-center gap-1.5 rounded-md bg-primary p-1.5 text-white'>
					<p className='text-base font-semibold'>Đơn bị từ chối</p>
					<p className='text-base font-semibold'>{data.reject}</p>
				</div>
			</div>
