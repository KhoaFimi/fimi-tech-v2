	...
	return (
		<div className='flex flex-col items-start gap-y-2 lg:flex-row lg:items-center lg:space-x-2'>
			...
			<input
				...
				className='h-10 w-full rounded-md border-2 border-primary px-1.5 text-lg font-semibold text-primary caret-primary placeholder:font-normal focus-visible:outline-none focus-visible:ring-0 lg:w-60'
			/>
			<ChevronRight className='hidden size-7 text-primary lg:block' />
			...
			>
				<TabsList className='grid h-10 w-full grid-cols-2 border border-primary lg:w-72'>
					<TabsTrigger
						value='personel'
						className='h-full data-[state=active]:bg-primary data-[state=active]:text-white'
					>
						Publisher
					</TabsTrigger>
					<TabsTrigger
